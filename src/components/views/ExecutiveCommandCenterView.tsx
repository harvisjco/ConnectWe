            ...
            {uncelebratedPromos.length > 0 ? (
              <div>
                <h3 
                  ...
                  className="text-sm font-bold text-white leading-snug cursor-pointer hover:text-amber-300 transition-colors"
                  title="임원 프로필 열기"
                >
              ...
              <div className="p-6 text-center text-xs text-slate-500 space-y-1">
                ...
                <div className="font-bold text-slate-300">모든 영전 축하 완료</div>
