                      ...
                      <div className="space-y-1">
                        {deal.stakeholders.map(s => {
                          ...
                          return (
                            <div
                              key={s.personId}
                              className="p-1.5 rounded-lg bg-slate-950 border border-slate-800/60 flex items-center justify-between text-[10px]"
                            >
                              <div className="truncate flex-1 min-w-0">
                                <span className="font-bold text-slate-200">{s.personName}</span>
